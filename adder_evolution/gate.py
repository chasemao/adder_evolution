...
class gate:
    ...
    def __init__(self, type: int):
        if type not in {self.type_and, self.type_or, self.type_not, self.type_xor}:
    ...
    def newRandomGate() -> 'gate':
        return gate(random.choices([gate.type_and, gate.type_or, gate.type_not, gate.type_xor])[0])
